...
const CartTableMobile = () => {
  return (
    <div className="md:hidden flex gap-3 mb-5 border-b pb-5">
      <div>
        <img
          src="https://i0.wp.com/demo4.drfuri.com/farmart2/wp-content/uploads/sites/11/2020/02/04_4a.jpg?w=800&ssl=1"
          alt=""
      ...
      <div className="flex-grow space-y-1">
        ...
        <p className="text-sm text-gray-500">
          Price: <span className="text-primary font-semibold">$100</span>
        </p>
        <div className="py-2">
          <Quantity />
        </div>
        <p className="text-sm text-gray-500">
          Price: <span className="text-green font-semibold">$100</span>
        </p>
      </div>
      <div className="mt-2">
